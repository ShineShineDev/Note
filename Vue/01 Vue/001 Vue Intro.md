...
- `Initial release  ,Feburary 2014 (Evan You)`

- `Front-end javiscript framework (user interface)`

- `Open source Model-view-viewmodel `
...
- `LightWeight than other framework such as react or angular`

- `Easy to learn`

- `Facebook for NewsFeed ,Netflix,Adobe,Alibaba,Laracasts,GitLab,`
...
- `Polymer uses web component features and requires polyfills for browsers, which does not support these features. VueJS does not have such dependencies and works fine in all browsers from `
...
```js
/* Vue
  - Initial release,Feburary 2014 (Evan You from Google)
  - ront-end javiscript framework (user interface)
  - Open source Model-view-viewmodel
  - Single Page Application
  - size 33KB min + gzip
*/ 
...
/* Why Vue 
  ...
  - Easy to learn
  - Facebook for NewsFeed ,Netflix,Adobe,Alibaba,Laracasts,GitLab,
  - It can be easily integrated into big projects for front-end development without any issues
*/  
/* Features
   Virtual DOM
   Data Binding 
